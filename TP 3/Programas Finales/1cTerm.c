...
int main(){
	...
	time_t prin,fin;
	time(&prin);
	int i,j,k,N=512,pasos=2000,termal=1000,desco=20,Nlut,tardanza;
	double rho=0.8442,potot,T,T2,crit,rc=2.5,h=0.001,dr=0.001,L,cinet;
	Nlut = (int) ceil(rc/dr);
	double *x;
	...
	for(k=0;k<23;k++){
		...
		// Ahora sí mido
		sprintf(filename,"Datos_Termalizaciones_Energias_MD_T=%lf.txt",T);
